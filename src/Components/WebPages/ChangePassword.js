...
function ChangePassword() {
    ...
    const [accountNumber, setAccountNumber] = useState(accNumber)
    ...
    const change = () => {
        ...
        //verify the new password and the re enter password
        ...
        <div style={mainDiv} >
            ...
            <div>
                <div className={styles.mainBox} >
                    ...
                    <br /><br />
                    <br/>
                    <a href={url}><button className={styles.buttonStyle} onClick={() => {
                        
                        //for phone verification
                        if (post.accountNumber == accountNumber && post.phone == mobile) {
                            setUrl("#popup1")
                        }
                        else if(accountNumber == null || mobile == null)
                        {
                            alert("Null Error")
                        }
                        else {
